...
entry:
  ...
  call fastcc void @copy_in([224 x [224 x [3 x float]]]* nonnull %0, [224 x [224 x [3 x float]]]* %image_copy, [112 x [112 x [32 x %"struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>"]]]* nonnull %1, [112 x [112 x [32 x i16]]]* %out0_copy, i32* nonnull %status, i32* nonnull align 512 %status_copy, i32* nonnull %magic, i32* nonnull align 512 %magic_copy)
  call void @apatb_lane_seg_top_hw([224 x [224 x [3 x float]]]* %image_copy, [112 x [112 x [32 x i16]]]* %out0_copy, i32 %ctrl, i32* %status_copy, i32* %magic_copy)
  call void @copy_back([224 x [224 x [3 x float]]]* %0, [224 x [224 x [3 x float]]]* %image_copy, [112 x [112 x [32 x %"struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>"]]]* %1, [112 x [112 x [32 x i16]]]* %out0_copy, i32* %status, i32* %status_copy, i32* %magic, i32* %magic_copy)
...
define internal fastcc void @copy_in([224 x [224 x [3 x float]]]* noalias readonly, [224 x [224 x [3 x float]]]* noalias, [112 x [112 x [32 x %"struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>"]]]* noalias readonly, [112 x [112 x [32 x i16]]]* noalias, i32* noalias readonly, i32* noalias align 512, i32* noalias readonly, i32* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_out([224 x [224 x [3 x float]]]* noalias, [224 x [224 x [3 x float]]]* noalias readonly, [112 x [112 x [32 x %"struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>"]]]* noalias, [112 x [112 x [32 x i16]]]* noalias readonly, i32* noalias, i32* noalias readonly align 512, i32* noalias, i32* noalias readonly align 512) unnamed_addr #4 {
entry:
  call fastcc void @onebyonecpy_hls.p0a224a224a3f32([224 x [224 x [3 x float]]]* %0, [224 x [224 x [3 x float]]]* %1)
  call fastcc void @"onebyonecpy_hls.p0a112a112a32struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>.13"([112 x [112 x [32 x %"struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>"]]]* %2, [112 x [112 x [32 x i16]]]* %3)
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a112a112a32struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>.13"([112 x [112 x [32 x %"struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>"]]]* noalias %dst, [112 x [112 x [32 x i16]]]* noalias readonly %src) unnamed_addr #2 {
entry:
...
copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a112a112a32struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>.16"([112 x [112 x [32 x %"struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>"]]]* nonnull %dst, [112 x [112 x [32 x i16]]]* nonnull %src, i64 112)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a112a112a32struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>.16"([112 x [112 x [32 x %"struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>"]]]* %dst, [112 x [112 x [32 x i16]]]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  call void @"arraycpy_hls.p0a112a32struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>.19"([112 x [32 x %"struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>"]]* %dst.addr, [112 x [32 x i16]]* %3, i64 112)
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a112a32struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>.19"([112 x [32 x %"struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>"]]* %dst, [112 x [32 x i16]]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  call void @"arraycpy_hls.p0a32struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>.22"([32 x %"struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>"]* %dst.addr, [32 x i16]* %3, i64 32)
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a32struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>.22"([32 x %"struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>"]* %dst, [32 x i16]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
...
declare void @apatb_lane_seg_top_hw([224 x [224 x [3 x float]]]*, [112 x [112 x [32 x i16]]]*, i32, i32*, i32*)

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_back([224 x [224 x [3 x float]]]* noalias, [224 x [224 x [3 x float]]]* noalias readonly, [112 x [112 x [32 x %"struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>"]]]* noalias, [112 x [112 x [32 x i16]]]* noalias readonly, i32* noalias, i32* noalias readonly align 512, i32* noalias, i32* noalias readonly align 512) unnamed_addr #4 {
entry:
  call fastcc void @"onebyonecpy_hls.p0a112a112a32struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>.13"([112 x [112 x [32 x %"struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>"]]]* %2, [112 x [112 x [32 x i16]]]* %3)
  call fastcc void @onebyonecpy_hls.p0i32(i32* %4, i32* align 512 %5)
  call fastcc void @onebyonecpy_hls.p0i32(i32* %6, i32* align 512 %7)
...
define void @lane_seg_top_hw_stub_wrapper([224 x [224 x [3 x float]]]*, [112 x [112 x [32 x i16]]]*, i32, i32*, i32*) #5 {
entry:
  %malloccall = tail call i8* @malloc(i64 802816)
  %5 = bitcast i8* %malloccall to [112 x [112 x [32 x %"struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>"]]]*
  call void @copy_out([224 x [224 x [3 x float]]]* null, [224 x [224 x [3 x float]]]* %0, [112 x [112 x [32 x %"struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>"]]]* %5, [112 x [112 x [32 x i16]]]* %1, i32* null, i32* %3, i32* null, i32* %4)
  %6 = bitcast [224 x [224 x [3 x float]]]* %0 to [224 x [3 x float]]*
  %7 = bitcast [112 x [112 x [32 x %"struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>"]]]* %5 to [112 x [32 x %"struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>"]]*
  call void @lane_seg_top_hw_stub([224 x [3 x float]]* %6, [112 x [32 x %"struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>"]]* %7, i32 %2, i32* %3, i32* %4)
  call void @copy_in([224 x [224 x [3 x float]]]* null, [224 x [224 x [3 x float]]]* %0, [112 x [112 x [32 x %"struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>"]]]* %5, [112 x [112 x [32 x i16]]]* %1, i32* null, i32* %3, i32* null, i32* %4)
  ret void
}

declare void @lane_seg_top_hw_stub([224 x [3 x float]]*, [112 x [32 x %"struct.ap_fixed<16, 4, AP_TRN, AP_WRAP, 0>"]]*, i32, i32*, i32*)
