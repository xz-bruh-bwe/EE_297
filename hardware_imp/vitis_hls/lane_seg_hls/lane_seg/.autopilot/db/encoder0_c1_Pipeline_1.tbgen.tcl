set moduleName encoder0_c1_Pipeline_1
set isTopModule 0
...
set C_modelName {encoder0_c1_Pipeline_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ padded float 32 regular {array 153228 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ padded_address0 sc_out sc_lv 18 signal 0 } 
	{ padded_ce0 sc_out sc_logic 1 signal 0 } 
	{ padded_we0 sc_out sc_logic 1 signal 0 } 
	{ padded_d0 sc_out sc_lv 32 signal 0 } 
}
set NewPortList {[ 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "153230", "Max" : "153230"}
	, {"Name" : "Interval", "Min" : "153230", "Max" : "153230"}
]}
...
set Spec2ImplPortList { 
	padded { ap_memory {  { padded_address0 mem_address 1 18 }  { padded_ce0 mem_ce 1 1 }  { padded_we0 mem_we 1 1 }  { padded_d0 mem_din 1 32 } } }
}
