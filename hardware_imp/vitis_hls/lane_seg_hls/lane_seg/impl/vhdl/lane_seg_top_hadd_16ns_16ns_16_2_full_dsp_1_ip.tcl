...
create_ip -name floating_point -version $fpo_ver -vendor xilinx.com -library ip -module_name lane_seg_top_hadd_16ns_16ns_16_2_full_dsp_1_ip
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Half \
                          ...
                          CONFIG.component_name lane_seg_top_hadd_16ns_16ns_16_2_full_dsp_1_ip \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips lane_seg_top_hadd_16ns_16ns_16_2_full_dsp_1_ip] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files lane_seg_top_hadd_16ns_16ns_16_2_full_dsp_1_ip.xci]
generate_target {synthesis simulation} [get_files lane_seg_top_hadd_16ns_16ns_16_2_full_dsp_1_ip.xci]
