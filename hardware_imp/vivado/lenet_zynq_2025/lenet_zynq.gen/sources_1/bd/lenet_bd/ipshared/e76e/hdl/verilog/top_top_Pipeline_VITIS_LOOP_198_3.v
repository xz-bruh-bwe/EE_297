...
initial begin
#0 ap_CS_fsm = 3'd1;
#0 argmax_fu_44 = 32'd0;
#0 max_val_1_fu_48 = 32'd0;
#0 argmax_1_fu_52 = 4'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (*) begin
    if (((icmp_ln198_fu_105_p2 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (icmp_ln198_fu_105_p2 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign and_ln200_fu_204_p2 = (or_ln200_fu_180_p2 & grp_fu_634_p_dout0);
...
assign grp_fu_634_p_din0 = logits_q0;

assign grp_fu_634_p_din1 = max_val_1_fu_48;
