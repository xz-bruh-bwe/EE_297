...
module top_top_Pipeline_VITIS_LOOP_191_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [61:0] sext_ln191;
input  [3:0] zext_ln188_1;
input  [1:0] trunc_ln2;
...
reg   [6:0] j_1_reg_342;
reg   [3:0] logits_addr_reg_347;
reg   [3:0] logits_addr_reg_347_pp0_iter1_reg;
reg   [3:0] logits_addr_reg_347_pp0_iter2_reg;
wire   [0:0] icmp_ln191_fu_233_p2;
wire   [6:0] add_ln191_fu_277_p2;
reg   [6:0] add_ln191_reg_376;
reg    ap_block_state2_pp0_stage1_iter0;
wire    ap_block_state6_pp0_stage1_iter1;
wire    ap_block_state10_pp0_stage1_iter2;
reg    ap_block_pp0_stage1_11001;
reg   [31:0] gmem_out_addr_read_reg_381;
wire   [31:0] tmp_fu_282_p6;
reg   [31:0] tmp_reg_386;
wire   [0:0] ifzero_fu_295_p2;
reg   [0:0] ifzero_reg_391;
reg   [0:0] ifzero_reg_391_pp0_iter1_reg;
reg   [0:0] ifzero_reg_391_pp0_iter2_reg;
wire   [31:0] bitcast_ln192_fu_301_p1;
wire    ap_CS_fsm_pp0_stage2;
wire    ap_block_state3_pp0_stage2_iter0;
wire    ap_block_state7_pp0_stage2_iter1;
wire    ap_block_state11_pp0_stage2_iter2;
wire    ap_block_pp0_stage2_11001;
reg   [31:0] mul_i_reg_400;
reg   [31:0] add_i_reg_410;
reg    ap_enable_reg_pp0_iter0_reg;
wire   [63:0] zext_ln188_cast_fu_207_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln192_1_fu_263_p1;
reg   [31:0] add_i37_fu_88;
reg   [31:0] ap_sig_allocacmp_add_i37_load;
...
wire   [7:0] zext_ln192_fu_239_p1;
wire   [7:0] sub_ln192_fu_251_p2;
wire   [7:0] zext_ln188_1_cast_fu_212_p1;
wire   [7:0] add_ln192_fu_257_p2;
reg    grp_fu_195_ce;
reg    grp_fu_199_ce;
reg    ap_done_reg;
...
top_top_Pipeline_VITIS_LOOP_191_2_fc3_weights_0_RAM_1P_LUTRAM_1R1W #(
    .DataWidth( 32 ),
    .AddressRange( 252 ),
    .AddressWidth( 8 ))
fc3_weights_0_U(
...
top_top_Pipeline_VITIS_LOOP_191_2_fc3_weights_1_RAM_1P_LUTRAM_1R1W #(
    .DataWidth( 32 ),
    .AddressRange( 252 ),
    .AddressWidth( 8 ))
fc3_weights_1_U(
...
top_top_Pipeline_VITIS_LOOP_191_2_fc3_weights_2_RAM_1P_LUTRAM_1R1W #(
    .DataWidth( 32 ),
    .AddressRange( 252 ),
    .AddressWidth( 8 ))
fc3_weights_2_U(
...
top_top_Pipeline_VITIS_LOOP_191_2_fc3_weights_3_RAM_1P_LUTRAM_1R1W #(
    .DataWidth( 32 ),
    .AddressRange( 252 ),
    .AddressWidth( 8 ))
fc3_weights_3_U(
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_fu_92 <= 7'd0;
    end else if (((icmp_ln191_reg_352 == 1'd0) & (1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        j_fu_92 <= add_ln191_reg_376;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        add_i_reg_410 <= grp_fu_830_p_dout0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        add_ln191_reg_376 <= add_ln191_fu_277_p2;
        ifzero_reg_391_pp0_iter1_reg <= ifzero_reg_391;
        ifzero_reg_391_pp0_iter2_reg <= ifzero_reg_391_pp0_iter1_reg;
        mul_i_reg_400 <= grp_fu_834_p_dout0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln191_reg_352 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        gmem_out_addr_read_reg_381 <= m_axi_gmem_out_RDATA;
        ifzero_reg_391 <= ifzero_fu_295_p2;
        tmp_reg_386 <= tmp_fu_282_p6;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        icmp_ln191_reg_352 <= icmp_ln191_fu_233_p2;
        j_1_reg_342 <= ap_sig_allocacmp_j_1;
        logits_addr_reg_347 <= zext_ln188_cast_fu_207_p1;
        logits_addr_reg_347_pp0_iter1_reg <= logits_addr_reg_347;
        logits_addr_reg_347_pp0_iter2_reg <= logits_addr_reg_347_pp0_iter1_reg;
    end
end

always @ (*) begin
    if (((icmp_ln191_reg_352 == 1'd1) & (1'b0 == ap_block_pp0_stage3_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ap_sig_allocacmp_add_i37_load = grp_fu_830_p_dout0;
    end else begin
        ap_sig_allocacmp_add_i37_load = add_i37_fu_88;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        fc3_weights_3_ce0 = 1'b1;
    end else begin
        fc3_weights_3_ce0 = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln191_reg_352 == 1'd0) & (1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (ifzero_reg_391_pp0_iter2_reg == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        logits_we0 = 1'b1;
    end else begin
        logits_we0 = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln191_reg_352 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
assign add_ln191_fu_277_p2 = (j_1_reg_342 + 7'd1);

assign add_ln192_fu_257_p2 = (sub_ln192_fu_251_p2 + zext_ln188_1_cast_fu_212_p1);
...
always @ (*) begin
    ap_block_pp0_stage1_11001 = ((m_axi_gmem_out_RVALID == 1'b0) & (icmp_ln191_reg_352 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage1_subdone = ((m_axi_gmem_out_RVALID == 1'b0) & (icmp_ln191_reg_352 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1));
end
...
always @ (*) begin
    ap_block_state2_pp0_stage1_iter0 = ((m_axi_gmem_out_RVALID == 1'b0) & (icmp_ln191_reg_352 == 1'd0));
end
...
assign bitcast_ln192_fu_301_p1 = gmem_out_addr_read_reg_381;

assign empty_fu_229_p1 = ap_sig_allocacmp_j_1[5:0];

assign fc3_weights_0_address0 = zext_ln192_1_fu_263_p1;

assign fc3_weights_1_address0 = zext_ln192_1_fu_263_p1;

assign fc3_weights_2_address0 = zext_ln192_1_fu_263_p1;

assign fc3_weights_3_address0 = zext_ln192_1_fu_263_p1;

assign grp_fu_830_p_ce = grp_fu_195_ce;

assign grp_fu_830_p_din0 = ap_sig_allocacmp_add_i37_load;

assign grp_fu_830_p_din1 = mul_i_reg_400;

assign grp_fu_830_p_opcode = 2'd0;

assign grp_fu_834_p_ce = grp_fu_199_ce;

assign grp_fu_834_p_din0 = bitcast_ln192_fu_301_p1;

assign grp_fu_834_p_din1 = tmp_reg_386;

assign icmp_ln191_fu_233_p2 = ((ap_sig_allocacmp_j_1 == 7'd84) ? 1'b1 : 1'b0);

assign ifzero_fu_295_p2 = ((add_ln191_fu_277_p2 == 7'd84) ? 1'b1 : 1'b0);

assign logits_address0 = logits_addr_reg_347_pp0_iter2_reg;

assign logits_d0 = add_i_reg_410;
...
assign sub_ln192_fu_251_p2 = (tmp_4_fu_243_p3 - zext_ln192_fu_239_p1);

assign tmp_4_fu_243_p3 = {{empty_fu_229_p1}, {2'd0}};

assign zext_ln188_1_cast_fu_212_p1 = zext_ln188_1;

assign zext_ln188_cast_fu_207_p1 = zext_ln188;

assign zext_ln192_1_fu_263_p1 = add_ln192_fu_257_p2;

assign zext_ln192_fu_239_p1 = ap_sig_allocacmp_j_1;

endmodule //top_top_Pipeline_VITIS_LOOP_191_2
