...
#
# Script generated by Vivado on Thu Sep 04 19:10:47 -0700 2025
...
#
# Usage        : top_0.sh
#                top_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                top_0.sh [-reset_run]
#                top_0.sh [-reset_log]
#                top_0.sh [-help]
#
...
#                script (type 'top_0.sh -help' for more information).
#
...
# script info
echo -e "top_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./top_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  vlogan -work floating_point_v7_1_15 $vlogan_opts +v2k +incdir+"../../../../lenet_zynq.gen/sources_1/ip/top_0/drivers/top_v1_0/src" \
  "../../../ipstatic/hdl/floating_point_v7_1_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log > vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../lenet_zynq.gen/sources_1/ip/top_0/drivers/top_v1_0/src" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.top_0 xil_defaultlib.glbl -o top_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./top_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key top_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc top_0_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./top_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: top_0.sh [-help]\n\
Usage: top_0.sh [-step]\n\
Usage: top_0.sh [-lib_map_path]\n\
Usage: top_0.sh [-reset_run]\n\
Usage: top_0.sh [-reset_log]\n\
Usage: top_0.sh [-keep_index]\n\
Usage: top_0.sh [-noclean_files]\n\n\
