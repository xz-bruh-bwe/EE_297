...
compile()
{
  ...
  xmvlog -work floating_point_v7_1_15 $xmvlog_opts +incdir+"../../../../lenet_zynq.gen/sources_1/ip/top_0/drivers/top_v1_0/src" \
  "../../../ipstatic/hdl/floating_point_v7_1_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log > xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../lenet_zynq.gen/sources_1/ip/top_0/drivers/top_v1_0/src" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.top_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.top_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log top_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
