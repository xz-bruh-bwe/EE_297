...
entity lenet_top_control_s_axi is
generic (
...
end entity lenet_top_control_s_axi;
...
architecture behave of lenet_top_control_s_axi is
    ...
    signal int_pool1_out       : UNSIGNED(63 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_POOL1_OUT_DATA_0 =>
                        rdata_data <= RESIZE(int_pool1_out(31 downto 0), 32);
                    when ADDR_POOL1_OUT_DATA_1 =>
                        rdata_data <= RESIZE(int_pool1_out(63 downto 32), 32);
                    ...
                    when ADDR_POOL2_OUT_DATA_0 =>
                        rdata_data <= RESIZE(int_pool2_out(31 downto 0), 32);
                    when ADDR_POOL2_OUT_DATA_1 =>
                        rdata_data <= RESIZE(int_pool2_out(63 downto 32), 32);
                    when ADDR_FLAT_OUT_DATA_0 =>
                        rdata_data <= RESIZE(int_flat_out(31 downto 0), 32);
                    when ADDR_FLAT_OUT_DATA_1 =>
                        rdata_data <= RESIZE(int_flat_out(63 downto 32), 32);
                    when ADDR_FC1_OUT_DATA_0 =>
...
-- ----------------------- Register logic ----------------
    ...
    pool1_out            <= STD_LOGIC_VECTOR(int_pool1_out);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_POOL1_OUT_DATA_0) then
                    int_pool1_out(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_pool1_out(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_POOL1_OUT_DATA_1) then
                    int_pool1_out(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_pool1_out(63 downto 32));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_POOL2_OUT_DATA_0) then
                    int_pool2_out(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_pool2_out(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_POOL2_OUT_DATA_1) then
                    int_pool2_out(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_pool2_out(63 downto 32));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_FLAT_OUT_DATA_0) then
                    int_flat_out(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_flat_out(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_FLAT_OUT_DATA_1) then
                    int_flat_out(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_flat_out(63 downto 32));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_FC1_OUT_DATA_0) then
                    int_fc1_out(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_fc1_out(31 downto 0));
                end if;
            end if;
        end if;
    end process;
