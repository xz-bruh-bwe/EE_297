# 1 "lenet_proj/lenet_support.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "lenet_proj/lenet_support.cpp" 2

# 1 "lenet_proj/lenet_top.h" 1
...
# 5 "lenet_proj/lenet_top.h" 2


typedef float data_t;
# 24 "lenet_proj/lenet_top.h"
void lenet_top(
    data_t image[28][28],
...
# 3 "lenet_proj/lenet_support.cpp" 2
...
#pragma HLS RESOURCE variable=padded core=RAM_1P_LUTRAM
 ...
 VITIS_LOOP_21_1: for (int i = 0; i < 28; i++) {
        VITIS_LOOP_22_2: for (int j = 0; j < 28; j++) {
            padded[i + 2][j + 2] = input[i][j];
        }
    }


    VITIS_LOOP_28_3: for (int out_c = 0; out_c < 6; out_c++) {
        VITIS_LOOP_29_4: for (int i = 0; i < 28; i++) {
            VITIS_LOOP_30_5: for (int j = 0; j < 28; j++) {
#pragma HLS PIPELINE
 data_t sum = 0.0;
                VITIS_LOOP_33_6: for (int ki = 0; ki < 5; ki++) {
                    VITIS_LOOP_34_7: for (int kj = 0; kj < 5; kj++) {
...
#pragma HLS INLINE off
 ...
 VITIS_LOOP_55_1: for (int c = 0; c < 6; c++) {
        VITIS_LOOP_56_2: for (int i = 0; i < 28; i += 2) {
            VITIS_LOOP_57_3: for (int j = 0; j < 28; j += 2) {
...
#pragma HLS INLINE off
 ...
 VITIS_LOOP_83_1: for (int oc = 0; oc < 16; oc++) {
        VITIS_LOOP_84_2: for (int i = 0; i < 10; i++) {
            VITIS_LOOP_85_3: for (int j = 0; j < 10; j++) {
#pragma HLS PIPELINE II
 data_t sum = 0.0f;

                VITIS_LOOP_89_4: for (int ic = 0; ic < 6; ic++) {
                    VITIS_LOOP_90_5: for (int ki = 0; ki < 5; ki++) {
                        VITIS_LOOP_91_6: for (int kj = 0; kj < 5; kj++) {
                ...
                sum += biases[oc];
                output[i][j][oc] = (sum > 0.0f) ? sum : 0.0f;
            }
        }
    }
}
...
#pragma HLS INLINE off
 ...
 VITIS_LOOP_112_1: for (int c = 0; c < 16; c++) {
        VITIS_LOOP_113_2: for (int i = 0; i < 10; i += 2) {
            VITIS_LOOP_114_3: for (int j = 0; j < 10; j += 2) {
#pragma HLS PIPELINE II=1
 data_t v0 = input[i][j][c];
                data_t v1 = input[i][j + 1][c];
                data_t v2 = input[i + 1][j][c];
...
#pragma HLS INLINE off
 ...
 int index = 0;
    VITIS_LOOP_138_1: for (int i = 0; i < 5; i++) {
        VITIS_LOOP_139_2: for (int j = 0; j < 5; j++) {
            VITIS_LOOP_140_3: for (int c = 0; c < 16; c++) {
#pragma HLS PIPELINE II
